...
-- Tiempo de generación: 18-11-2023 a las 06:50:06
...
--
-- Estructura de tabla para la tabla `detalle_pedidotemporal`
--

DROP TABLE IF EXISTS `detalle_pedidotemporal`;
CREATE TABLE IF NOT EXISTS `detalle_pedidotemporal` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `productoid` bigint NOT NULL,
  `precio` decimal(11,2) NOT NULL,
  `cantidad` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `permisos` (
  ...
  `leer` int DEFAULT NULL,
  `escribir` int DEFAULT NULL,
  `actualizar` int DEFAULT NULL,
  `borrar` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `indentificacion` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  ...
  `password` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `nit` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `nombrefical` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `direccionfiscal` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `toke` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `rolid` bigint NOT NULL,
  `datecreated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` int NOT NULL DEFAULT '1',
...
--
-- Filtros para la tabla `detalle_pedidotemporal`
--
ALTER TABLE `detalle_pedidotemporal`
  ADD CONSTRAINT `detalle_pedidotemporal_ibfk_1` FOREIGN KEY (`productoid`) REFERENCES `producto` (`idproducto`) ON DELETE CASCADE ON UPDATE CASCADE;
